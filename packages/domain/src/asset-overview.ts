 ...
 *
 * Written for the web page first (apps/web/src/lib/asset-overview.ts) and moved
 * here unchanged when the phone's asset screen took the same shape (v2.62):
 * both apps now read one rule for which picture leads and which tiles exist,
 * so a laptop and the phone beside it show the same overview.
 */
